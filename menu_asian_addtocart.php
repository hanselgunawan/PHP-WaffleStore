...
<?php
	...
	function buatrp($angka){
		...
		$batas=9;
		$tampil3=mysql_query("SELECT * FROM product WHERE kategori_product='asianfood' AND product_status='available'");
	...
	$query="SELECT * FROM product WHERE kategori_product='asianfood' AND product_status='available' LIMIT $halaman1,$batas";
...
?>
        ...
        <h6>menu &#10148; asian food</h6>
        <div id="submenu">
        	<ul>
        		<li><a href="menu_all.php">All</a></li>
        		<li><a href="menu_asianfood.php" style="color:purple">Asian Food</a></li>
       ...
       <div id="menu_all">
		...
		?>
            ...
            <a href="cart.php?action=add&amp;id=<?php echo $row['productid']; ?>&amp;ref=menu_asianfood.php?halaman=<?php echo $halaman; ?>" onClick="info()"><img src="images/addtocart_logo.jpg" class="addtocart_button"></a></li>
            <?php } ?>
        </ul>
        <?php
			$tampil2=mysql_query("SELECT * FROM product WHERE kategori_product='asianfood' AND product_status='available'");
        ...
        <div style="margin-left:60%;" id="pagination">
                ...
                {?>
                <a href="menu_asianfood.php?halaman=1" style="text-decoration:none;">&#8610;First</a>
                <a href="menu_asianfood.php?halaman=<?php echo $halaman-1; ?>" style="text-decoration:none; font-size:11pt">&#8676;previous</a>
                <?php } ?>
                <?php
				for($b=1;$b<=$jml_halaman;$b++)
						{
							if($jml_halaman>1)
							{
									?><a href="menu_asianfood.php?halaman=<?php echo $b; ?>" style="text-decoration:none;" class="paging">
									<?php 
									if($halaman==$b)
									{
         ...
         <a href="menu_asianfood.php?halaman=<?php echo $halaman+1; ?>" style="text-decoration:none; font-size:11pt;">next&#8677;</a>
         <a href="menu_asianfood.php?halaman=<?php echo $jml_halaman; ?>" style="text-decoration:none;">Last&#8611;</a>
         <?php }?></div>
